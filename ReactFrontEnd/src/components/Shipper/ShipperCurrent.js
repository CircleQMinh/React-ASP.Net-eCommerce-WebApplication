...
import CurrentOrderItem from "./TableItem/CurrentOrderItem";
function ShipperCurrent() {
  ...
  useEffect(() => {
    setIsLoading(true);
    ShipperService.getAcceptedOrders(shipperId, orderby, sort, pageNumber, pageSize)
      .then((response) => {
            ...
            <div className="container  py-3 ">
              <div className="card p-3">
                <p className="lead text-center mb-0 fw-bold fs-3 text-monospace">
                  {" "}
                  <i className="fa-solid fa-magnifying-glass me-2"></i>Đơn hàng đã nhận
                </p>
              </div>
              <div className="row">
                <div className="col">
                    ...
                    <div className="card-header">
                      <div className="d-flex justify-content-between flex-wrap">
                        <div className="col-sm-12 ">
                          <h5 className="card-title">Bảng đơn hàng đã nhận giao</h5>
                        </div>
                        <div className="col-sm-12 ">
